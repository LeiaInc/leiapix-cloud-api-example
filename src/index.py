...
S3_PRESIGNED_URL_BUCKET = os.getenv('S3_PRESIGNED_URL_BUCKET')
S3_PRESIGNED_URL_BUCKET_REGION = os.getenv('S3_PRESIGNED_URL_BUCKET_REGION')
...
if not S3_PRESIGNED_URL_BUCKET or not S3_PRESIGNED_URL_BUCKET_REGION:
    print('Error. In order to use Leia Media Cloud API, you need to provide S3_PRESIGNED_URL_BUCKET and '
          'S3_PRESIGNED_URL_BUCKET_REGION env vars', file=sys.stderr)
    exit(1)
...
ORIGINAL_IMAGE_URL = os.getenv('ORIGINAL_IMAGE_URL', 'https://images.pexels.com/photos/38771/pexels-photo-38771.jpeg'
...
s3 = boto3.client('s3', region_name=S3_PRESIGNED_URL_BUCKET_REGION)
